...
#    CUDA_VISIBLE_DEVICES=0,1,2,3 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_msp.yaml --num-gpus=4 #
...
#    CUDA_VISIBLE_DEVICES=0,1,2,3 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_fg.yaml --num-gpus=4
...
#    CUDA_VISIBLE_DEVICES=0,1,2,3 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_all.yaml --num-gpus=4
...
#    CUDA_VISIBLE_DEVICES=0,1,2,3 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_unk_score.yaml --num-gpus=4
