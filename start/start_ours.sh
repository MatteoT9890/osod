...
#    CUDA_VISIBLE_DEVICES=0,1 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/zero_std/noreg/test_open_cwwr_all.yaml --num-gpus=2
    CUDA_VISIBLE_DEVICES=0,1 python $PYTHONPATH/src/main/test.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_msp.yaml --num-gpus=2
    CUDA_VISIBLE_DEVICES=0,1 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_msp.yaml --num-gpus=2
    CUDA_VISIBLE_DEVICES=0,1 python $PYTHONPATH/src/main/test.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_energy.yaml --num-gpus=2
    CUDA_VISIBLE_DEVICES=0,1 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_energy.yaml --num-gpus=2
    CUDA_VISIBLE_DEVICES=0,1 python $PYTHONPATH/src/main/test.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_odin.yaml --num-gpus=2
    CUDA_VISIBLE_DEVICES=0,1 python $PYTHONPATH/src/main/collect_results.py --config=$PYTHONPATH/conf/ours/one_std/noreg/test_open_cwwr_odin.yaml --num-gpus=2
